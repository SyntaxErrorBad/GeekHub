...
def add_products(request):
    if request.user.is_superuser:
        ...
        return render(request, 'manage_products/add_products.html', {'form': form})
    else:
        return redirect('my_products')
...
def my_products(request):
    ...
    return render(request, 'manage_products/my_products.html', {
        'products': products,
...
def category_page(request, category):
    ...
    return render(request, 'manage_products/categories_page.html', {
        'categories': categories,
        'products': products,
    })
...
def product_detail(request, product_id):
    try:
        ...
        return render(request, 'manage_products/product_detail.html', {'product': product})
...
def exeption_page(request):
    return render(request, 'manage_products/exeption_page.html')
